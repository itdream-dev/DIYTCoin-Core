...
#   c) node1 mines 32 blocks, so now node 0 has 60001DIYT node 1 has 4250DIYT node2 has none.
#   d) node0 sends 601 DIYTto node2, in two transactions (301 DIYT then 300 DIYT.
