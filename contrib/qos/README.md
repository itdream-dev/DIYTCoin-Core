...
This means one can have an always-on diytubed instance running, and another local diytubed/diytube-qt instance which connects to this node and receives blocks from it.
