...
RESOURCES += src/qt/diytube.qrc src/qt/diytube_locale.qrc

TRANSLATIONS += src/qt/locale/diytube_bg.ts \
                src/qt/locale/diytube_de.ts \
                src/qt/locale/diytube_en.ts \
                src/qt/locale/diytube_es.ts \
                src/qt/locale/diytube_fi.ts \
                src/qt/locale/diytube_fr.ts \
                src/qt/locale/diytube_it.ts \
                src/qt/locale/diytube_ja.ts \
                src/qt/locale/diytube_pl.ts \
                src/qt/locale/diytube_pt.ts \
                src/qt/locale/diytube_ru.ts \
                src/qt/locale/diytube_sk.ts \
                src/qt/locale/diytube_sv.ts \
                src/qt/locale/diytube_vi.ts \
                src/qt/locale/diytube_zh_CN.ts \
                src/qt/locale/diytube_zh_TW.ts
