...
UniValue stop(const UniValue& params, bool fHelp) {
    ...
    StartShutdown();
    return "Diytube server stopping";
}
...
static const CRPCCommand vRPCCommands[] = {
    ...
    /* Pivx features */
    {"diytube", "masternode", &masternode, true, true, false},
    {"diytube", "listmasternodes", &listmasternodes, true, true, false},
    {"diytube", "getmasternodecount", &getmasternodecount, true, true, false},
    {"diytube", "masternodeconnect", &masternodeconnect, true, true, false},
    {"diytube", "masternodecurrent", &masternodecurrent, true, true, false},
    {"diytube", "masternodedebug", &masternodedebug, true, true, false},
    {"diytube", "startmasternode", &startmasternode, true, true, false},
    {"diytube", "createmasternodekey", &createmasternodekey, true, true, false},
    {"diytube", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
    {"diytube", "listmasternodeconf", &listmasternodeconf, true, true, false},
    {"diytube", "getmasternodestatus", &getmasternodestatus, true, true, false},
    {"diytube", "getmasternodewinners", &getmasternodewinners, true, true, false},
    {"diytube", "getmasternodescores", &getmasternodescores, true, true, false},
    {"diytube", "mnbudget", &mnbudget, true, true, false},
    {"diytube", "preparebudget", &preparebudget, true, true, false},
    {"diytube", "submitbudget", &submitbudget, true, true, false},
    {"diytube", "mnbudgetvote", &mnbudgetvote, true, true, false},
    {"diytube", "getbudgetvotes", &getbudgetvotes, true, true, false},
    {"diytube", "getnextsuperblock", &getnextsuperblock, true, true, false},
    {"diytube", "getbudgetprojection", &getbudgetprojection, true, true, false},
    {"diytube", "getbudgetinfo", &getbudgetinfo, true, true, false},
    {"diytube", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
    {"diytube", "mnfinalbudget", &mnfinalbudget, true, true, false},
    {"diytube", "checkbudgets", &checkbudgets, true, true, false},
    {"diytube", "mnsync", &mnsync, true, true, false},
    {"diytube", "spork", &spork, true, true, false},
    {"diytube", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
    {"diytube", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
std::string HelpExampleCli(string methodname, string args) {
    return "> diytube-cli " + methodname + " " + args + "\n";
}
