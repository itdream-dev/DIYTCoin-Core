...
/**
    ...
    ****Note - for Diytube we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
class CCoinsViewCache : public CCoinsViewBacked {
  ...
  public:
    ...
    /**
     * Amount of diytube coming in to a transaction
