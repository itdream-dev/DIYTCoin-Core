...
static bool AppInitRawTx(int argc, char* argv[]) {
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Diytube Core diytube-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  diytube-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded diytube transaction") + "\n" +
                               "  diytube-tx [options] -create [commands]   " + _("Create hex-encoded diytube transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[]) {
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded diytube transaction
