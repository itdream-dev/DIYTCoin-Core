...
/** Utility functions used by the Diytube Qt UI.
 */
namespace GUIUtil {
...
// Render Diytube addresses in monospace font
...
// Parse "diytube:" URI into recipient object, return true on successful parsing
