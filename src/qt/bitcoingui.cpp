...
BitcoinGUI::BitcoinGUI(const NetworkStyle* networkStyle, QWidget* parent) : QMainWindow(parent),
    ...
    QString windowTitle = tr("Diytube Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle) {
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Diytube address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and diytube: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDIYT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("About Diytube Core"), this);
    aboutAction->setStatusTip(tr("Show information about Diytube Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("Options"), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Diytube"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Diytube addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("Verify Message"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Diytube addresses"));
    ...
    openAction->setStatusTip(tr("Open a Diytube: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Diytube Core help message to get a list with possible Diytube command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle) {
    ...
    QString toolTip = tr("Diytube Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count) {
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Diytube network", "", count));
}
...
void BitcoinGUI::message(const QString& title, const QString& message, unsigned int style, bool* ret) {
    QString strTitle = tr("Diytube Core"); // default title
