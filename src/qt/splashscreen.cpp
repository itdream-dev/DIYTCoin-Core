...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0) {
    ...
    QString titleText = tr("Diytube Core");
    ...
    QString copyrightTextDiytube = QChar(0xA9) + QString(" 2019- ") + QString(tr("The Diytube Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextDiytube);
