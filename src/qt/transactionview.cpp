...
TransactionView::TransactionView(QWidget* parent) : QWidget(parent), model(0), transactionProxyModel(0),
    ...
    typeWidget->addItem(tr("Received DIYT From zDIYT"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change In zDIYT"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDIYT));
