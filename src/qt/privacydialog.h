...
class PrivacyDialog : public QDialog {
  ...
  public:
    ...
    void setZDiytControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzDIYT_clicked();
    void on_pushButtonSpendzDIYT_clicked();
    void on_pushButtonZDIYTControl_clicked();
