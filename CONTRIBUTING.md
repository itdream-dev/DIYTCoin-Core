Contributing to Diytube Core
============================

The Diytube Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Diytube Core project, and is not to be
confused with overall Diytube Network Protocol consensus changes.

Whether a pull request is merged into Diytube Core rests with the project merge
...
Patches that change Diytube consensus rules are considerably more involved than
...
Where a patch set proposes to change the Diytube consensus, it must have been
...
The project leader is the release manager for each Diytube Core release.
